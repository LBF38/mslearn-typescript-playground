...
import * as allGreetingFunctions from "./greetings-utilities_module.js"; // imports all functions in the module
import { returnGreeting as returnGreetingLength } from "./greetings-utilities_module.js"; // imports a single function in the module
